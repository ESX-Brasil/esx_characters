...
RegisterServerEvent("esx_charactersS:SetupCharacters")
AddEventHandler('esx_charactersS:SetupCharacters', function()
    local src = source
    ...
    TriggerClientEvent('esx_charactersC:SetupUI', src, Characters)
end)

RegisterServerEvent("esx_charactersS:CharacterChosen")
AddEventHandler('esx_charactersS:CharacterChosen', function(charid, ischar)
    local src = source
    local spawn = {}
    ...
    TriggerClientEvent("esx_charactersC:SpawnCharacter", src, spawn)
end)

RegisterServerEvent("esx_charactersS:DeleteCharacter")
AddEventHandler('esx_charactersS:DeleteCharacter', function(charid)
    local src = source
    DeleteCharacter(GetPlayerIdentifiers(src)[1], charid)
    TriggerClientEvent("esx_charactersC:ReloadCharacters", src)
end)
